...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["Ambitious", "Beautiful", "Charming", "Delight", "Ethereal", "Forever", "Gorgeous", "Happy", "Illustrious", "Jubilant", "Kindness", "Luminous", "Mellifluous", "Noble","Odyssey","Pure","Quill","Rainbow","Sunrise","Twilight", "Universe","Victory","Wonderful","Xenial","Yours","Zenith"];
